...
export BOT_SCAN_SERIES_ALLOWLIST="KXHIGHT,KXSILVERD,KXGOLDMON,KXBTCD,KXETHD,KXSOLD,KXXRPD,KXNASDAQ100MINY"
...
# ── Execution allowlist ───────────────────────────────────────────────────────
export BOT_EXECUTION_SERIES_ALLOWLIST="KXHIGHT,KXBTCD,KXETHD,KXXRPD,KXSOLD,KXGOLDD,KXGOLDMON,KXSILVERD,KXSILVERMON,KXSILVERW,KXBRENTW,KXBRENTMON,KXWTIMAX,KXNATGASMON,KXSUGARMON,KXLCATTLEMON,KXCOPPERMON,KXNASDAQ100MINY"
